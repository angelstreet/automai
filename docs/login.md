...
This document provides comprehensive information about the authentication system in the AutomAI application, covering both the traditional database authentication and Supabase integration.

## Table of Contents

1. [Overview](#overview)
2. [Authentication Methods](#authentication-methods)
3. [NextAuth Implementation](#nextauth-implementation)
4. [Google OAuth Integration](#google-oauth-integration)
5. [GitHub OAuth Integration](#github-oauth-integration)
6. [Email/Password Authentication](#emailpassword-authentication)
7. [Supabase Authentication](#supabase-authentication)
8. [Environment-Based Configuration](#environment-based-configuration)
9. [Plan and Tenant Management](#plan-and-tenant-management)
...
### Authentication Flow with Tenant Handling
