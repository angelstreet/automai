...
const CryptoWidget = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-orange-500 to-red-600 p-3 rounded-lg shadow-lg w-56 h-64 text-white relative">
      <h3 className="text-sm font-semibold mb-2 opacity-90 pt-6">Crypto Prices</h3>
