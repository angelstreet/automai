...
const CalculatorWidget = () => {
  ...
  return (
    <div className="bg-white p-3 rounded-lg shadow-lg w-56 h-64 relative">
      <h3 className="text-sm font-semibold text-gray-600 mb-2 pt-6">Calculator</h3>
      <div className="bg-gray-100 p-2 mb-2 rounded text-right text-lg font-mono min-h-[32px] flex items-center justify-end">
        {display}
      </div>
      <div className="grid grid-cols-4 gap-1 h-36">
