                ...
                <div>
                  <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 rounded-md p-4 mb-4">
                    ...
                    <p className="text-red-600 dark:text-red-400">
                      The deployment failed during execution of{' '}
                      <strong>{deployment.scripts.find((s) => s.status === 'failed')?.name}</strong>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-md p-4">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-sm text-gray-700 dark:text-gray-300">
                      ...
                      <li>
                        Scripts: {deployment.scripts.filter((s) => s.status === 'success').length}{' '}
                        successful, {deployment.scripts.filter((s) => s.status === 'failed').length}{' '}
                        failed, {deployment.scripts.filter((s) => s.status === 'pending').length}{' '}
                        not executed
                      </li>
                    </ul>
                  </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-md p-4">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-sm text-gray-700 dark:text-gray-300">
                      ...
                      <li>Scripts: {deployment.scripts.length} executed successfully</li>
                      <li>
                        Total Duration:{' '}
                        {calculateDuration(deployment.startTime, deployment.endTime)}
                      </li>
