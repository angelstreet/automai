...
export const sampleDeployments: Deployment[] = [
  {
    ...
    logs: [
      ...
      {
        timestamp: '2025-03-03T08:02:40.000Z',
        level: 'INFO',
        message: 'process_data.py completed successfully',
      },
      {
        timestamp: '2025-03-03T08:02:45.000Z',
        level: 'INFO',
        message: 'Running generate_report.py',
      },
      {
        timestamp: '2025-03-03T08:08:30.000Z',
        level: 'INFO',
        message: 'generate_report.py completed successfully',
      },
      {
        timestamp: '2025-03-03T08:15:30.000Z',
        level: 'INFO',
  ...
  },
  {
    ...
    scripts: [
      {
        id: 4,
        name: 'archive_logs.sh',
        path: '/maintenance/archive_logs.sh',
        status: 'success',
        duration: '1m 30s',
      },
      {
        id: 5,
        name: 'backup_db.py',
        path: '/maintenance/backup_db.py',
        status: 'failed',
        duration: '10m 40s',
      },
    ],
    hosts: [{ id: 2, name: 'Production DB Server', ip: '192.168.1.11', environment: 'Production' }],
    logs: [
      ...
      {
        timestamp: '2025-03-02T01:01:45.000Z',
        level: 'INFO',
        message: 'archive_logs.sh completed successfully',
      },
      { timestamp: '2025-03-02T01:02:00.000Z', level: 'INFO', message: 'Running backup_db.py' },
      {
        timestamp: '2025-03-02T01:12:40.000Z',
        level: 'ERROR',
        message: 'Database connection timed out',
      },
      {
        timestamp: '2025-03-02T01:12:50.000Z',
        level: 'ERROR',
        message: 'backup_db.py failed with exit code 1',
      },
  ...
  },
  {
    ...
    scripts: [
      {
        id: 6,
        name: 'generate_monthly_report.py',
        path: '/reports/generate_monthly_report.py',
        status: 'in_progress',
        duration: '10m',
      },
      {
        id: 7,
        name: 'send_alerts.py',
        path: '/alerting/send_alerts.py',
        status: 'pending',
        duration: null,
      },
    ],
    hosts: [{ id: 3, name: 'Staging Server', ip: '192.168.2.10', environment: 'Staging' }],
    logs: [
      { timestamp: '2025-03-01T23:00:00.000Z', level: 'INFO', message: 'Deployment started' },
      {
        timestamp: '2025-03-01T23:00:15.000Z',
        level: 'INFO',
        message: 'Running generate_monthly_report.py',
      },
    ],
  },
  {
    ...
    scripts: [
      ...
      },
      {
        ...
        path: '/src/fetch_api_data.js',
        status: 'pending',
        duration: null,
      },
    ],
    hosts: [{ id: 4, name: 'Dev Environment', ip: '192.168.3.10', environment: 'Development' }],
    logs: [],
  },
];
