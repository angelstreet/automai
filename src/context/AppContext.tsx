...
export const lazyImports = {
  HostProvider: React.lazy(() =>
    import('./HostContext').then((mod) => ({ default: mod.HostProvider })),
  ),
  RepositoryProvider: React.lazy(() =>
    import('./RepositoryContext').then((mod) => ({ default: mod.RepositoryProvider })),
  ),
  DeploymentProvider: React.lazy(() =>
    import('./DeploymentContext').then((mod) => ({ default: mod.DeploymentProvider })),
  ),
  CICDProvider: React.lazy(() =>
    import('./CICDContext').then((mod) => ({ default: mod.CICDProvider })),
  ),
};
