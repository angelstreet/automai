...
@execution_results_bp.route('/server/executionResults/record', methods=['POST'])
...
@execution_results_bp.route('/server/executionResults/recordBatch', methods=['POST'])
...
@execution_results_bp.route('/server/executionResults/confidence', methods=['GET'])
def get_confidence():
...
@execution_results_bp.route('/server/executionResults/history', methods=['GET'])
def get_history():
...
@execution_results_bp.route('/server/executionResults/teamStats', methods=['GET'])
def get_team_stats():
...
@execution_results_bp.route('/server/executionResults/recordVerification', methods=['POST'])
...
@execution_results_bp.route('/server/executionResults/recordAction', methods=['POST'])
