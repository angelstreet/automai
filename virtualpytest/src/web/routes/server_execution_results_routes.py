...
@execution_results_bp.route('/server/execution-results/record', methods=['POST'])
...
@execution_results_bp.route('/server/execution-results/record-batch', methods=['POST'])
...
@execution_results_bp.route('/server/execution-results/confidence', methods=['GET'])
def get_confidence():
...
@execution_results_bp.route('/server/execution-results/history', methods=['GET'])
def get_history():
...
@execution_results_bp.route('/server/execution-results/team-stats', methods=['GET'])
def get_team_stats():
